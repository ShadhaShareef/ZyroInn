...
<div class="max-w-3xl space-y-8">
  ...
  <?php if ($saved): ?>
      <div class="rounded-2xl bg-emerald-50 border border-emerald-200 p-4 text-sm font-semibold text-emerald-800 flex items-center gap-2">
          <span class="w-5 h-5 text-emerald-500"><?= svg_icon('check') ?></span>
          Property settings saved successfully.
        </div>
      <?php endif; ?>
      <?php if ($error): ?>
        <div class="rounded-2xl bg-rose-50 border border-rose-200 p-4 text-sm font-semibold text-rose-800 flex items-center gap-2">
